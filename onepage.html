...
<div class="overflow_wrapper">
     <header>
          <div class="container">
               <div class="logo"><a class="brand" href="index.html"> <img src="images/cleanstart_logo.png" alt="optional logo"> <span class="logo_title">Cleanstart</span></a></div>
     ...
     <div class="full_page_photo" id="video" data-video="http://plethorathemes.com/cleanstart-html/images/video.mp4" data-imagefallback="images/1.jpg">
          <div class="container">
               <div class="hgroup centered">
                    <div class="hgroup_title animated bounceInUp ">
                         <div class="container">
                              <h1>One Page Theme Alternative</h1>
                         </div>
                    </div>
                    <div class="hgroup_subtitle animated bounceInUp skincolored">
                         <div class="container">
                              <p>you can <strong>Trust</strong> &amp; <strong>Build upon</strong>!</p>
                         </div>
                    </div>
               </div>
          </div>
     ...
     <div class="main">
          ...
          <section class="call_to_action">
               <div class="container"> <img alt="responsive" src="images/rocket_trans.png">
                    <h3>Focus on what’s <strong><span class="rotate">Important, Simple, Inovative</span></strong></h3>
                    <h4>and  make the web a little bit  prettier</h4>
                    <a class="btn btn-primary" href="#">Buy this theme!</a> </div>
          </section>
          <section id="services" class="features_teasers_wrapper">
               <div class="container">
                    <h2 class="section_header fancy centered">we design value into profit<small>our customers are always happy</small></h2>
                    <div class="row">
                         <div class="col-sm-4 col-md-4">
                              <div class="service_teaser vertical">
                                   ...
                                   <div class="service_details">
                                        <h2>Design</h2>
                                        <p>Quisque at lectus leo, nec placerat mi. Curabitur egestas eleifend interdum. Suspendisse potenti. Suspendisse nec risus fermentum. </p>
                                   </div>
                              </div>
                         </div>
                         <div class="col-sm-4 col-md-4">
                              <div class="service_teaser vertical">
                                   ...
                                   <div class="service_details">
                                        <h2>Development</h2>
                                        <p>Quisque at lectus leo, nec placerat mi. Curabitur egestas eleifend interdum. Suspendisse potenti. Suspendisse nec risus fermentum. </p>
                                        <a class="btn btn-primary" href="documentation/index.html">Call to Action</a> </div>
                              </div>
                         </div>
                         <div class="col-sm-4 col-md-4">
                              <div class="service_teaser vertical">
          ...
          <section class="portfolio_teasers_wrapper" id="portfolio">
               <div class="container">
                    ...
                    <div class="portfolio_strict row">
                         <div class="col-sm-4 col-md-4">
                              <div class="portfolio_item wow flipInX"> <a href="images/portfolio/item/5.jpg">
                         ...
                         <div class="col-sm-4 col-md-4">
                              <div class="portfolio_item"> <a href="images/portfolio/item/5.jpg">
          ...
          <section class="team_members" id="about_us">
               <div class="container">
                    <h2 class="section_header fancy centered">we really love what we do<small>while always trying to get the job done!</small></h2>
                    <div class="row team_members_wrapper">
                         <div class="col-sm-6 col-md-3">
                              <div class="team_member">
                                   ...
                                   <hr>
                                   <div class="team_social"> <a href="https://www.facebook.com/plethorathemes"><i class="fa fa-facebook"></i></a> <a href="https://twitter.com/PlethoraThemes"><i class="fa fa-twitter"></i></a> <a href="#pinterest"><i class="fa fa-linkedin"></i></a> <a href="https://github.com/PlethoraThemes"><i class="fa fa-github-alt"></i></a> </div>
                         ...
                         <div class="col-sm-6 col-md-3">
                              <div class="team_member">
                                   ...
                                   <hr>
                                   <div class="team_social"> <a href="https://www.facebook.com/plethorathemes"><i class="fa fa-facebook"></i></a> <a href="https://twitter.com/PlethoraThemes"><i class="fa fa-twitter"></i></a> <a href="#pinterest"><i class="fa fa-linkedin"></i></a> <a href="#googleplus"><i class="fa fa-google-plus"></i></a> </div>
                                   <p class="short_bio">In hac habitasse platea dictumst. Suspendisse non tellus ligula. Morbi molestie feugiat tortor a hendrerit.</p>
                              </div>
                         </div>
                    </div>
                              ...
                              <div class="container">
                                   <div class="row">
                                        <div class="office_address col-sm-4 col-md-4">
                                             <div class="team_member"> <img src="images/plethora_logo_white.png"  alt="logo">
                                                  <h5>PLETHORA THEMES</h5>
                    ...
                    <section class="copyright">
                         ...
                         <div class="container">
                              <div class="row">
                                   ...
                                   <div class="text-right col-sm-6 col-md-6"> Designed by <a href="http://www.plethorathemes.com/">Plethora Themes</a> </div>
                              </div>
                         </div>
                    </section>
               </footer>
